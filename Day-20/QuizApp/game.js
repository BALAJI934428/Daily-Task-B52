...
progressValue.setAttribute("class", "progress-bar progress-bar-striped progress-bar-animated");
...
progressValue.setAttribute('aria-label',"Animated striped example");
